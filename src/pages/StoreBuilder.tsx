...
import { Store, ArrowLeft, Phone, CheckCircle } from 'lucide-react';
import { storePricing, generateWhatsAppMessage, whatsappNumber } from '@/data/pricing';
          ...
          <div className="flex items-center gap-2">
            <div className="flex-1 h-2 neu-card-inset rounded-full overflow-hidden">
              <div 
                ...
                style={{ width: `${Math.min((selectedOptions.length / 3) * 100, 100)}%` }}
              />
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex gap-3 w-full sm:w-auto">
              {!showForm && selectedOptions.length > 0 && (
                <button
